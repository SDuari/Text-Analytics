...
#############################################################################
# Experiments on corpus: Text Preprocessing
#############################################################################
...
# DegExt ALGORITHM
nodes_deg_w = strength(deg_graph, mode = "all", loops = FALSE, weights = get.edge.attribute(deg_graph, name = "weight")) # strength calculatesweighted degree
...
wordcloud(d$word,d$freq,min.freq=1, random.color = TRUE, random.order = TRUE, colors = c("blue","green","yellow","red"))  # creates word cloud with text size corresponding to frequency
